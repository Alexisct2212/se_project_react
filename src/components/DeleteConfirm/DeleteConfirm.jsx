...
function DeleteConfirm({activeModal,closeActiveModal,selectedCard,handleDeleteCard}){
    const onCardDelete = () => {
    ...
    <div className={`modal ${
       ...
       <div className="modal__form modal__content modal__content_delete">
        ...
        <p className="modal__delete_text">Are you sure you want to delete this item?
        This action is irreversible.</p>
        <div>
            <button className="confirm__delete_btn" onClick={onCardDelete}>
                Yes,Delete
            </button>
            <button onClick={closeActiveModal} className="cancel__delete_btn">Cancel</button>
        </div>
       </div>
    </div>
    )
